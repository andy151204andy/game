...
bgm = pygame.mixer.Sound(f"{AUDIO_PATH}bgm.mp3")
sound_good = pygame.mixer.Sound(f"{AUDIO_PATH}green.mp3")
sound_bad = pygame.mixer.Sound(f"{AUDIO_PATH}red.mp3")
sound_normal = pygame.mixer.Sound(f"{AUDIO_PATH}normal.mp3")
sound_end = pygame.mixer.Sound(f"{AUDIO_PATH}end.mp3")
sound_buy = pygame.mixer.Sound(f"{AUDIO_PATH}buy.mp3")
sound_error = pygame.mixer.Sound(f"{AUDIO_PATH}error.mp3")
sound_stage = pygame.mixer.Sound(f"{AUDIO_PATH}stage.mp3")
